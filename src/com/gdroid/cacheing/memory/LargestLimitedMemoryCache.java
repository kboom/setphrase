...
/**
 * Limited {@link V object } cache. Provides {@link V objects } storing. Size of
 * all stored bitmaps will not to exceed size limit. When cache reaches limit
 * size then the bitmap which used the least frequently is deleted from cache.
 */
public abstract class LargestLimitedMemoryCache<K, V> extends
	 ...
	 */
	private final Map<V, Integer> valueSizes = Collections
			.synchronizedMap(new HashMap<V, Integer>());
