 ...
 */
public class LimitedAgeMemoryCache<K, V> implements MemoryCacheable<K, V> {

	private final MemoryCacheable<K, V> cache;
	 ...
	 */
	public LimitedAgeMemoryCache(MemoryCacheable<K, V> cache, long maxAge) {
		this.cache = cache;
