 ...
 */
public abstract class FreqLimitedMemoryCache<K, V> extends
	 ...
	 */
	private final Map<V, Integer> usingCounts = Collections
			.synchronizedMap(new HashMap<V, Integer>());

	public FreqLimitedMemoryCache(int sizeLimit) {
		super(sizeLimit);
	}
